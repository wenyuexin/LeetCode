...
public class RegularExpressionMatching3_ {
	//Solution2 - 施工中
	...
	public static void main(String[] args) {
		...
		boolean flag = new RegularExpressionMatching3_().isMatch(s,p);
		...
		System.out.println(Arrays.toString(RegularExpressionMatching3_.pFilter(p)));
